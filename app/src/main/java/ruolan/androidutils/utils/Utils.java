package ruolan.androidutils.utils;
...
public class Utils {
    ...
    /**
     * 拨打电话  加入 <uses-permission android:name="android.permission.CALL_PHONE"/>权限
     *
     * @param context     上下文
    ...
    /**
     * 唤醒屏幕解锁  加入  <uses-permission android:name="android.permission.DISABLE_KEYGUARD" />权限
     *
     * @param context 上下文
     */
    ...
    /**
     * 判断当前App是处于前台还是后台
     * 加入  <uses-permission android:name="android.permission.GET_TASKS" />权限(6.0之后不需要加入)
     *
     * @param context
     * @return true/false
     */
    ...
    /**
     * 获取当前设备的MAC地址
     * 加入 <uses-permission android:name="android.permission.ACCESS_WIFI_STATE" />权限
     *
     * @param context
     * @return
     */
    ...
    public static Properties collectDeviceInfo(Context context) {
        String VERSION_NAME = null, VERSION_CODE = null;
        ...
        try {
            ...
            Log.e("e", "Error while collect package info", e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                Log.e("e", "Error while collect crash info", e);
            }
        }
